 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.acceptanceTest.impl.CaseImpl#getItems <em>Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CaseImpl extends MinimalEObjectImpl.Container implements Case
{
  ...
  {
    return AcceptanceTestPackage.Literals.CASE;
  }
  ...
  public EList<Item> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<Item>(Item.class, this, AcceptanceTestPackage.CASE__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AcceptanceTestPackage.CASE__ITEMS:
